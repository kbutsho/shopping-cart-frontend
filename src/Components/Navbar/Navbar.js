        ...
        <div style={{ margin: "65px 0" }}>
            <nav className="navbar navbar-expand-lg navbar-light bg-dark fixed-top" >
                <div className="container">
                    <a href="/" style={{ fontSize: '20px' }} className='fw-bold text-white text-decoration-none'><img style={{ margin: "0 15px 0 0", width: '20%' }} src='https://cdn-icons-png.flaticon.com/128/4290/4290854.png' alt='' /> <span className=''>Ecommerce</span></a>
